...
import static com.codefuel.ringtonemaker.Ringdroid.soundfile.MP4Header.getMP4Header;
...
public class SoundFile {
    ...
    public void WriteWAVFile(File outputFile, float startTime, float endTime)
        ...
        FileOutputStream outputStream = new FileOutputStream(outputFile);
        outputStream.write(com.codefuel.ringtonemaker.RTone.soundfile.WAVHeader.getWAVHeader(mSampleRate, mChannels, numSamples));
