...
/**
 * Main screen that shows up when you launch RTone. Handles selecting
...
import com.codefuelindia.ringtonemaker.Adapters.SongsAdapter;
import com.codefuelindia.ringtonemaker.Models.SongsModel;
import com.codefuelindia.ringtonemaker.R;
import com.codefuelindia.ringtonemaker.Ringdroid.Constants;
import com.codefuelindia.ringtonemaker.Ringdroid.Utils;
import com.codefuelindia.ringtonemaker.Views.FastScroller;
...
import static com.codefuelindia.ringtonemaker.Ringdroid.Constants.REQUEST_ID_MULTIPLE_PERMISSIONS;
import static com.codefuelindia.ringtonemaker.Ringdroid.Constants.REQUEST_ID_READ_CONTACTS_PERMISSION;
import static com.codefuelindia.ringtonemaker.Ringdroid.Constants.REQUEST_ID_RECORD_AUDIO_PERMISSION;
...
public class RingdroidSelectActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private void confirmDelete(int pos) {
        // See if the selected list item was created by RTone to
...
//        String itemUri = c.getString(uriIndex) + "/" + c.getString(c.getColumnIndexOrThrow(MediaStore.Audio.Media._ID));
    ...
    private void onRecord() {
        try {
            ...
            Log.e("RTone", "Couldn't start editor");
        }
    }
