...
package com.codefuelindia.ringtonemaker.Ringdroid.soundfile;
...
import static com.codefuelindia.ringtonemaker.Ringdroid.soundfile.MP4Header.getMP4Header;
...
public class SoundFile {
    ...
    public void WriteFile(File outputFile, float startTime, float endTime)
        ...
        try {
            ...
            outputStream.write(
                    getMP4Header(mSampleRate, numChannels, frame_sizes, bitrate));
            ...
            Log.e("RTone", "Failed to create the .m4a file.");
    ...
    public void WriteWAVFile(File outputFile, float startTime, float endTime)
        ...
        FileOutputStream outputStream = new FileOutputStream(outputFile);
        outputStream.write(com.codefuelindia.ringtonemaker.RTone.soundfile.WAVHeader.getWAVHeader(mSampleRate, mChannels, numSamples));
    ...
    private void DumpSamples(String fileName) {
        ...
        try {
            ...
            Log.w("RTone", "Failed to create the sample TSV file.");
            Log.w("RTone", getStackTrace(e));
        }
        // We are done here. Close the file and rewind the buffer.
        try {
            writer.close();
        } catch (Exception e) {
            Log.w("RTone", "Failed to close sample TSV file.");
            Log.w("RTone", getStackTrace(e));
        }
        mDecodedSamples.rewind();
    }
